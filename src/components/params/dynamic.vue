<template>
  <div>
    <el-button type="primary" size="mini" :disabled="attributes.meta? false: true" @click="dialogFormVisible = true">添加参数</el-button>
    <el-dialog title="添加动态参数" width="30%" :visible.sync="dialogFormVisible">
  <el-form :model="form" >
    <el-form-item label="动态参数" :rules="name" :label-width="formLabelWidth">
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-dialog title="修改动态参数" width="30%" :visible.sync="dialogVisible">
